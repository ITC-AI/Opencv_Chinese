...
#
prefix       := /home/disk/wcp/Coding/Coding-Rknn/Ocr/Font/Arm/freetype-2.13.2/INSTALL
exec_prefix  := ${prefix}
...
PKGCONFIG_REQUIRES         := 
PKGCONFIG_REQUIRES_PRIVATE := harfbuzz >= 2.0.0
PKGCONFIG_LIBS             := -L${libdir} -lfreetype
PKGCONFIG_LIBS_PRIVATE     := 
LIBSSTATIC_CONFIG          := -lfreetype -lharfbuzz -lm -lglib-2.0 -pthread -lpcre -pthread -lgraphite2
build_libtool_libs         := 
ft_version                 := 26.1.20
